    ...
    <div className="min-h-screen bg-[#FAFAF8]">
      ...
      <section className="max-w-[800px] mx-auto px-4 py-10">
        <div className="space-y-8">
          {/* Service Description */}
          <div>
            <h2 className="text-2xl font-bold text-[#1B4D3E] mb-4">Service Description</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#1B4D3E] mb-4">Booking and Cancellation Policy</h2>
            <ul className="list-disc list-inside space-y-3 text-gray-600">
              ...
              <li>
                ...
                are eligible for a full refund. Cancellations made within 24 hours are subject to a 50% cancellation charge.
              </li>
              <li>
          ...
          {/* Pricing */}
          <div>
            <h2 className="text-2xl font-bold text-[#1B4D3E] mb-4">Pricing and Payment</h2>
            <ul className="list-disc list-inside space-y-3 text-gray-600">
              <li>
          ...
          {/* Liability */}
          <div>
            <h2 className="text-2xl font-bold text-[#1B4D3E] mb-4">Liability and Limitations</h2>
            <ul className="list-disc list-inside space-y-3 text-gray-600">
              <li>
          ...
          {/* User Conduct */}
          <div>
            <h2 className="text-2xl font-bold text-[#1B4D3E] mb-4">User Conduct and Responsibilities</h2>
            <p className="text-gray-600 leading-relaxed mb-3">By using our services, you agree to:</p>
          ...
          {/* Governing Law */}
          <div>
            <h2 className="text-2xl font-bold text-[#1B4D3E] mb-4">Governing Law</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          {/* Changes to Terms */}
          <div>
            <h2 className="text-2xl font-bold text-[#1B4D3E] mb-4">Changes to Terms</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          {/* Contact */}
          <div>
            <h2 className="text-2xl font-bold text-[#1B4D3E] mb-4">Contact Us</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              For questions about these Terms of Service, please contact us at:
            </p>
            <div className="p-4 bg-white rounded-lg border border-gray-100 text-gray-700">
              <p><strong>Email:</strong> vikramkashyap980@gmail.com</p>
              <p className="mt-2"><strong>Phone:</strong> 8091783474</p>
            </div>
          </div>
        </div>
      </section>
