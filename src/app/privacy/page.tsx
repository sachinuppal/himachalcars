    ...
    <div className="min-h-screen bg-[#FAFAF8]">
      ...
      <section className="max-w-[800px] mx-auto px-4 py-10">
        <div className="space-y-8">
          {/* Introduction */}
          <div>
            <h2 className="text-2xl font-bold text-[#1B4D3E] mb-4">Introduction</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#1B4D3E] mb-4">Information We Collect</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#1B4D3E] mb-4">How We Use Your Information</h2>
          ...
          {/* Data Sharing */}
          <div>
            <h2 className="text-2xl font-bold text-[#1B4D3E] mb-4">Data Sharing and Disclosure</h2>
          ...
          {/* Cookies */}
          <div>
            <h2 className="text-2xl font-bold text-[#1B4D3E] mb-4">Cookies and Tracking Technologies</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          {/* Data Security */}
          <div>
            <h2 className="text-2xl font-bold text-[#1B4D3E] mb-4">Data Security</h2>
            <p className="text-gray-600 leading-relaxed">
